package jp.suntech.c22005.bmicalculatorc005;
...
public class MainActivity extends AppCompatActivity {
    ...
    private double calculateLorentzIndex(double weight, double height, int age) {
        double heightInMeters = height / 100.0;
        return weight / (heightInMeters * heightInMeters * heightInMeters) * 10;
    }
    ...
    private void displayResult(String indexName, double indexValue) {
        ...
        String idealWeightText = String.format("%.2f", idealWeight);
